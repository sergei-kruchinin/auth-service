...
def register_routes(bp: Blueprint):
    ...
    @bp.route("/login/yandex/by_code.html", methods=["GET"])
    ...
    @bp.route("/login/yandex.html", methods=["GET"])
    ...
    @bp.route("/login/yandex/callback.html", methods=["GET"])
    def auth_yandex_callback_html():
        ...
        api_domain = os.getenv('API_DOMAIN')
        callback_uri = f"https://{api_domain}/login/yandex/callback.html"
